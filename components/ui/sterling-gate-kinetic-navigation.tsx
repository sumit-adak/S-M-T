    ...
    <div ref={containerRef} className="kinetic-nav-wrapper">
      <div className="nav-row__right">
        ...
        <div className="nav-toggle-label" onClick={toggleMenu} style={{ cursor: 'pointer', pointerEvents: 'auto' }}>
          <span className="toggle-text">{isMenuOpen ? "close menu" : "explore menu"}</span>
        </div>
        
        {/* Menu Button */}
        <button role="button" className={`nav-close-btn ${isMenuOpen ? 'is-active' : ''}`} onClick={toggleMenu} style={{ pointerEvents: 'auto' }} aria-label="Toggle Navigation">
      ...
      <section className="fullscreen-menu-container">
        <div data-nav="closed" className="nav-overlay-wrapper">
          ...
          <nav className="menu-content">
            ...
            {/* Explicit Drawer Header with Close Button */}
            <div className="menu-drawer-header" data-menu-fade>
              <span className="menu-drawer-title">Navigation</span>
              <button className="drawer-close-action-btn" onClick={closeMenu} aria-label="Close menu">
                <span>Close</span>
              ...
              <ul className="menu-list">
                ...
                <li className="menu-list-item" data-shape="3">
                  <a href="/timeline" onClick={closeMenu} className="nav-link w-inline-block">
                    <p className="nav-link-text">Timeline</p>
                    <div className="nav-link-hover-bg"></div>
                  </a>
                </li>
                <li className="menu-list-item" data-shape="4">
                  <a href="/blogs" onClick={closeMenu} className="nav-link w-inline-block">
